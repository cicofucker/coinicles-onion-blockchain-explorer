...
/**
* Parse coinicles address in a string form into
...
/**
* Return string representation of coinicles address
*/
string
...
{
    // default path to coinicles folder
    // on linux this is /home/<username>/.coinicles
